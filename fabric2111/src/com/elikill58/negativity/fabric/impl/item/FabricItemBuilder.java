...
public class FabricItemBuilder extends ItemBuilder {
	...
	public ItemBuilder enchant(Enchantment enchantment, int level) {
		item.addEnchantment(RegistryEntry.of(FabricEnchants.getFabricEnchant(enchantment)), level);
		return this;
	}
	...
	public ItemBuilder itemFlag(ItemFlag... itemFlag) {
		for(ItemFlag flag : itemFlag) {
			...
			case HIDE_ATTRIBUTES:
				item.set(DataComponentTypes.TOOLTIP_DISPLAY, new TooltipDisplayComponent(true, new LinkedHashSet<>(Arrays.asList(DataComponentTypes.ATTRIBUTE_MODIFIERS))));
				break;
			case HIDE_ENCHANTS:
				item.set(DataComponentTypes.TOOLTIP_DISPLAY, new TooltipDisplayComponent(true, new LinkedHashSet<>(Arrays.asList(DataComponentTypes.ENCHANTMENTS, DataComponentTypes.STORED_ENCHANTMENTS))));
				break;
			case HIDE_UNBREAKABLE:
				item.set(DataComponentTypes.TOOLTIP_DISPLAY, new TooltipDisplayComponent(true, new LinkedHashSet<>(Arrays.asList(DataComponentTypes.UNBREAKABLE))));
				break;
			}
		}
		return this;
