...
public class FabricEntity<E extends Entity> extends AbstractEntity {
	...
	public FabricEntity(E e) {
		this.entity = e;
		this.loc = FabricLocation.toCommon(e.getEntityWorld(), e.getEntityPos());
	}
	...
	public Location getEyeLocation() {
		...
		return new Location(World.getWorld(entity.getEntityWorld().asString(), a -> new FabricWorld(entity.getEntityWorld())), vec.getX(), vec.getY(), vec.getZ());
	}
