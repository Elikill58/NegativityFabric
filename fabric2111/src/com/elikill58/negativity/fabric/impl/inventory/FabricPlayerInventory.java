...
public class FabricPlayerInventory extends PlayerInventory {
	...
	private Optional<ItemStack> getItemOpt(int slot) {
		net.minecraft.item.ItemStack i = inv.getStack(slot);
		return i == null ? Optional.empty() : Optional.of(new FabricItemStack(i));
	}

	protected Optional<ItemStack> getItemOpt(net.minecraft.item.ItemStack i) {
		return i == null ? Optional.empty() : Optional.of(new FabricItemStack(i));
	}
	...
	public ItemStack get(int slot) {
		return getItem(inv.getStack(slot));
	}
	...
	public Optional<ItemStack> getHelmet() {
		return getItemOpt(103);
	}

	@Override
	public Optional<ItemStack> getChestplate() {
		return getItemOpt(102);
	}

	@Override
	public Optional<ItemStack> getLegging() {
		return getItemOpt(101);
	}

	@Override
	public Optional<ItemStack> getBoots() {
		return getItemOpt(100);
	}
