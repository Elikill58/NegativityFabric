...
public class FabricPotionEffectType {
	...
	public static RegistryEntry<StatusEffect> getEffect(com.elikill58.negativity.api.potion.PotionEffectType type) {
		switch (type) {
		case BLINDNESS:
	...
	public static com.elikill58.negativity.api.potion.PotionEffectType getEffect(RegistryEntry<StatusEffect> effect) {
		for(PotionEffectType type : PotionEffectType.values()) {
			if(effect.getIdAsString().equalsIgnoreCase(type.getId()))
				return type;
		}
		return null;
	}
