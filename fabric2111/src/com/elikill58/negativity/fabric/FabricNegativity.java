...
public class FabricNegativity implements DedicatedServerModInitializer {
	...
	public static final Id<NegativityMessagePayload> ID_NEGATIVITY = new CustomPayload.Id(Identifier.of(NegativityMessagesManager.CHANNEL_ID));
	public static final Id<FMLMessagePayload> ID_FML = new CustomPayload.Id(Identifier.of("fml:hs"));
	public static final Id<BungeecordSendToServerMessagePayload> ID_BUNGEECORD = new CustomPayload.Id(Identifier.of("bungeecord"));
