...
public class PacketListeners extends NettyPacketListener {
	...
	public Channel getChannel(Player p) {
		try {
			ClientConnection co = ReflectionUtils.getFirstWith(((ServerPlayerEntity) p.getDefault()).networkHandler, ServerCommonNetworkHandler.class, ClientConnection.class);
