...
public class Fabric_1_19 extends FabricVersionAdapter {
	...
	public Fabric_1_19() {
		...
		packetsPlayIn.put(getNameOfPacket(PlayerInteractEntityC2SPacket.class), (pa, f) -> {
			...
			Object action = get(f, "field_12871");
			Enum<?> actionType = getFromMethod(action, "method_34211");
		...
		packetsPlayOut.put(getNameOfPacket(EntityStatusEffectS2CPacket.class), (p, f) -> {
			...
			return new NPacketPlayOutEntityEffect(packet.getEntityId(), PotionEffectType.fromId(packet.getEffectId()), packet.getAmplifier(),
